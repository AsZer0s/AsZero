(function (e) {
          ...
          return Object(n["c"])(this, function (n) {
            switch (n.label) {
              ...
              case 1:
                ...
                n.label = 2;
              case 2:
                return n.trys.push([2, 4, , 5]), [4, d(a, r, c, e)];
              case 3:
                return [2, n.sent()];
              case 4:
                return (
                  (l = n.sent()),
                  console.warn("在线获取曲目信息失败，回退到本地 meta 提取", l),
                  [3, 5]
                );
              case 5:
                return (
                  (b = Object(o["f"])(t, c.common.title, c.common.artist)),
                  (b.artist = b.artist || ""),
                  (p = Object(o["d"])(c)),
                  p ? [3, 7] : [4, f(b.title, b.artist, c.common.album)]
                );
              case 6:
                (p = n.sent()), (n.label = 7);
              case 7:
  ...
  2: function (e, t) {},
  "2e83": function (e, t, r) {
    e.exports = r.p + "js/0.fab5c26d.worker.js";
  },
  3: function (e, t) {},
  "321b": function (e, t, r) {
    "use strict";
            ...
            console.error(e, t),
              this.$notify.error({
                ...
                message:
                  ...
                  "，" +
                  t +
                  '，参考<a target="_blank" href="https://zerospace.dev">Zer0Teams</a>',
    ...
    function V(e, t) {
      return Object(n["a"])(this, void 0, Promise, function () {
        ...
        return Object(n["c"])(this, function (n) {
          switch (n.label) {
            case 0:
              return q["a"] instanceof Q["a"] ? [4, q["a"].setAll(t)] : [3, 2];
            case 1:
              n.sent(), (n.label = 2);
            case 2:
            ...
            case 28:
              return (o = n.sent()), [3, 31];
            case 29:
              throw '无法解锁，请联系<a target="_blank" href="https://zerospace.dev">CLI版本</a>';
            case 30:
              throw "不支持此文件格式";
            case 31:
              return (
  ...
  9224: function (e) {
    e.exports = JSON.parse(
      '{"name":"unlock-music","version":"1.10.8","ext_build":0,"updateInfo":"修正 joox 在远程获取 API 信息出错时不能正确回退到本地元信息获取的错误。","license":"MIT","description":"Unlock encrypted music file in browser.","repository":{"type":"git","url":"https://zerospace.dev/"},"private":true,"scripts":{"postinstall":"patch-package","serve":"vue-cli-service serve","build":"vue-cli-service build","test":"jest","pretty":"prettier --write src/{**/*,*}.{js,ts,jsx,tsx,vue}","pretty:check":"prettier --check src/{**/*,*}.{js,ts,jsx,tsx,vue}","make-extension":"node ./make-extension.js"},"dependencies":{"@babel/preset-typescript":"^7.16.5","@unlock-music/joox-crypto":"^0.0.1","@xhacker/kgmwasm":"^1.0.0","@xhacker/qmcwasm":"^1.0.0","base64-js":"^1.5.1","browser-id3-writer":"^4.4.0","core-js":"^3.16.0","crypto-js":"^4.1.1","element-ui":"^2.15.5","iconv-lite":"^0.6.3","jimp":"^0.16.1","metaflac-js":"^1.0.5","music-metadata":"7.9.0","music-metadata-browser":"2.2.7","register-service-worker":"^1.7.2","threads":"^1.6.5","vue":"^2.6.14"},"devDependencies":{"@types/crypto-js":"^4.0.2","@types/jest":"^27.0.3","@vue/cli-plugin-babel":"^4.5.13","@vue/cli-plugin-pwa":"^4.5.13","@vue/cli-plugin-typescript":"^4.5.13","@vue/cli-service":"^4.5.13","babel-plugin-component":"^1.1.1","jest":"^27.4.5","patch-package":"^6.4.7","prettier":"2.5.1","sass":"^1.38.1","sass-loader":"^10.2.0","semver":"^7.3.5","threads-plugin":"^1.4.0","typescript":"^4.5.4","vue-cli-plugin-element":"^1.0.1","vue-template-compiler":"^2.6.14"}}'
    );
  },
  "97e5": function (e, t, r) {
    "use strict";
  ...
  cd49: function (e, t, r) {
    ...
    var n = r("6ed5"),
      ...
      ue = se,
      le = (r("5c0b"), Object(ie["a"])(ue, Q, V, !1, null, null, null)),
      de = le.exports,
      fe = r("9483");
    "https:" === window.location.protocol &&
      Object(fe["a"])("".concat("", "service-worker.js"), {
        ready: function () {
      ...
      z["default"].use(l.a),
      z["default"].use(s.a),
      (z["default"].prototype.$notify = c.a),
      (z["default"].prototype.$confirm = i.a.confirm),
      (z["default"].config.productionTip = !1),
      new z["default"]({
        render: function (e) {
          return e(de);
        },
